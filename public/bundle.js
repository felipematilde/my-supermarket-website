...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return BackendHandler; });\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n\nclass BackendHandler {\n  async sendElementToDatabase(element) {\n    const p = () => axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('http://.../api/product', element);\n\n    try {\n      console.log(await p());\n    } catch (err) {\n      console.log(\"An error has happened :(\");\n    }\n  }\n\n  async getElementsFromBackend(name = \"\") {\n    let elements = [];\n    let url;\n    name === \"\" ? url = 'http://.../api/product' : url = `http://.../api/product/${name}`;\n\n    const p = () => axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url);\n\n    try {\n      elements = (await p()).data;\n    } catch (err) {\n      console.log(\"An error has happened :(\");\n    }\n\n    return elements;\n  }\n\n}\n\n//# sourceURL=webpack:///./src/backendHandler.js?");
